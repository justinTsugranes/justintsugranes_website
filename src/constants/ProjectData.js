const projectData = {
  recipes: {
    ...
    tech: 'HTML, CSS',
    imageUrl: require('../../src/assets/img/project-images/recipes.jpg'),
  ...
  crashcourse: {
    ...
    imageUrl: require('../../src/assets/img/project-images/crashcourses.jpg'),
  ...
  frontendbootcamp: {
    ...
    descr:
      'An example of a landing page for a Frontend Bootcamp where I learned more about using Bootstrap',
    tech: 'Bootstrap, HTML, CSS',
    imageUrl: require('../../src/assets/img/project-images/frontend-bootcamp.jpg'),
  ...
  landingpage: {
    ...
    tech: 'HTML, CSS, Figma',
    imageUrl: require('../../src/assets/img/project-images/landing-page.jpg'),
    demo: 'https://justin-tsugranes-company-landing-ex.netlify.app/',
    repo: 'https://github.com/justinTsugranes/project_landing-page'
  },
  megamask: {
    id: 5,
    title: 'MegaMask',
    ...
    imageUrl: require('../../src/assets/img/project-images/megamask.jpg'),
  ...
  nexttailwindblog: {
    ...
    tech: 'HTML, CSS',
    imageUrl: require('../../src/assets/img/project-images/next-tailwind-blog.jpg'),
  ...
  passwordgenerator: {
    ...
    tech: 'JavaScript, HTML, CSS',
    imageUrl: require('../../src/assets/img/project-images/password-generator.jpg'),
  ...
  reacttodo: {
    ...
    tech: 'HTML, CSS',
    imageUrl: require('../../src/assets/img/project-images/react-todo.jpg'),
